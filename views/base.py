...
class View:
    ...
    def get_tournament(self):
        ...
        tournament_info = {
            ...
            "place": input("Merci de saisir la localisation du tournois : "),
            "date": input("merci de saisir une date pour le tournois : "),
            "description": input("merci de saisir une description pour le tournois : "),
        }
    ...
    def get_number_of_rounds(self):
        ...
        if rounds_choice == "Y" or rounds_choice == "y":
            round_number = int(input("Saississez le nombre de tours pour le tournois"))
    ...
    def ask_player_number(self):
        player_number = int(input("combien de joueur souhaitez vous ajouter ?"))
    ...
    def set_player_ranking(self, players):
        choice = int(input("Numéro du joueur choisi:"))
    ...
    def post_tournament_ranking(self, players):
        ...
        for player in players:
            ...
            print(f"{player_name} {player_surname}" f" ancien classement : {old_rank}")
